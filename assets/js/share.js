...
(function () {
  ...
  const REGISTRY = {
    ...
    'doc-arenda': { title: 'Договор аренды жилья', url: '/documents/dogovor-arendy.html', type: 'document', icon: 'ph-house', template: 'arenda' },
    'doc-otpusk': { title: 'Заявление на отпуск', url: '/documents/zayavlenie-otpusk.html', type: 'document', icon: 'ph-airplane', template: 'otpusk' },
    'doc-doverennost': { title: 'Доверенность', url: '/documents/doverennost.html', type: 'document', icon: 'ph-signature', template: 'doverennost' },
    'doc-kompred': { title: 'Коммерческое предложение', url: '/documents/kommercheskoye-predlozheniye.html', type: 'document', icon: 'ph-currency-rub', template: 'kompredlozheniye' },
    'doc-uvolnenie': { title: 'Заявление на увольнение', url: '/documents/zayavlenie-uvolnenie.html', type: 'document', icon: 'ph-sign-out', template: 'uvolnenie' },
    'doc-raspiska': { title: 'Расписка в получении денег', url: '/documents/raspiska-dengi.html', type: 'document', icon: 'ph-money', template: 'raspiska' },
    'doc-akt': { title: 'Акт приёма-передачи', url: '/documents/akt-priemki.html', type: 'document', icon: 'ph-handshake', template: 'akt' },
